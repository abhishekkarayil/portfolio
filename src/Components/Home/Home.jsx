...
const Home = () => {
  ...
  <div className='flex items-center justify-end gap-1'>
    ...
    <span className='tracking-wide'>LOCAL TIME: <Time /></span>
  </div>
</div>
        ...
        <div className='w-full flex relative mt-8'>
          ...
          <div className='absolute bottom-38 left-2 md:bottom-41 md:left-0 lg:bottom-68'>
            <ul className='flex gap-5 md:gap-4 lg:gap-7 rounded-full px-3 py-2 md:px-4 md:py-2 lg:px-5 lg:py-2.5'>
              {socialItems.map((social, index) => (
                <li key={index}>
                  <a 
                    ...
                    target='_blank' 
                    rel='noreferrer' 
                    className='inline-flex items-center text-sm md:text-base lg:text-xl hover:text-gray-300 transition-colors'
        ...
        <Link to='/contact'>
          <button className='absolute bg-[#4A4A4A] text-white text-xs md:text-sm lg:text-base px-4 py-1 md:px-5 md:py-1 lg:px-10 lg:py-2.5 rounded-full bottom-1 right-2 md:bottom-0 lg:bottom-0 lg:right-5 hover:bg-[#3c3c3c] transition-colors duration-300 font-medium'>
            Say Hello
          </button>
          </Link>
        </div>
