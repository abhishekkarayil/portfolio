    ...
    <section className='w-full relative flex flex-col  justify-center md:px-15 lg:px-50 px-5 mt-20 '>
      <div className='flex flex-col justify-between items-start'>
        ...
        <div className='w-full flex  relative  mt-5 '>
          ...
          <img src={ptImage} alt="abhishek" oading="lazy"decoding="async" className='absolute lg:w-[300px] h-26 ml-45 md:w-50 md:h-[245px] md:ml-100 bottom-[1px] lg:h-[350px] lg:ml-180 lg:bottom-[0.5px]' />
          <button className='absolute bg-[#4A4A4A] text-white text-[6px] px-3 py:1.5 outline-4
