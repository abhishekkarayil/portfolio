    ...
    return (
        <div className='lg:px-50 md:px-15 mt-15 px-2.5'>
            <div className='flex justify-center flex-col items-center relative shadow-2xl rounded-2xl gap-3.5 '>
                ...
                <div className='w-full hidden md:flex justify-end mt-10 pr-10'>
                    <button className='flex items-center gap-2 text-[#1E1E1E] bg-[#F5F5F5] px-4 py-1 rounded-full hover:cursor-pointer hover:bg-[#e1dddd] transition-all'>
                        View Resume <MdOutlineArrowOutward />
                    </button>
                </div>
                
                <div className='flex md:flex-row flex-col lg:gap-15 gap-5 px-3.5 lg:px-25 lg:mt-8'>
                    <div className='flex flex-col items-center lg:items-start gap-7'>
                        <h2 className='text-5xl text-[#535353] font-medium'>About Me</h2>
                    ...
                    <div className='md:mt-8 lg:mt-16 flex flex-col items-start'>
                ...
                <div className='flex flex-wrap gap-3.5 mt-6 p-2'>
                    {skills.map((skill, index) => (
                        <span
                            key={index}
                            className={`lg:px-7 px-4 py-1.5 text-sm rounded-md shadow-sm hover:cursor-pointer ${
                                index === 0
