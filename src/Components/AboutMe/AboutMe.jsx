...
function AboutMe() {
  ...
  const handleResumeClick = (e) => {
    ...
    link.href = "/Resume/ABHISHEK-K-CV.pdf";
    link.download = "ABHISHEK-K-CV.pdf";
    link.target = "_blank";
      ...
      <div className="flex justify-center flex-col items-center relative shadow-2xl rounded-2xl gap-3.5">
        ...
        <div className="flex md:flex-row flex-col mt-4 lg:gap-15 gap-5 px-3.5 lg:px-25 md:px-10 lg:mt-8">
          <div className="flex flex-col items-center lg:items-start gap-5">
            <h2 className="text-5xl lg:text-5xl md:text-3xl text-[#535353] font-medium">
              About Me
            </h2>
          ...
          <div className="md:mt-13 lg:mt-18 flex flex-col items-start">
            <p className="text-gray-700 leading-relaxed text-sm lg:text-lg">
              I'm a passionate Web Developer specializing in React and modern
              front-end technologies. I enjoy turning complex problems into
              simple, elegant digital experiences. With a strong focus on
              responsive design and clean code, I create web applications that
              are fast, accessible, and visually engaging.
            </p>
            <p className="text-gray-700 mt-1 leading-relaxed text-sm lg:text-lg">
              I'm constantly exploring new tools and frameworks to improve my
              workflow and deliver better user experiences. My goal is to build
